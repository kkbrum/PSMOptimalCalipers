...
<!-- badges: start -->
  [![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/kkbrum/PSMOptimalCalipers?branch=master&svg=true)](https://ci.appveyor.com/project/kkbrum/PSMOptimalCalipers)
...
[![Travis build status](https://travis-ci.com/kkbrum/PSMOptimalCalipers.svg?branch=master)](https://travis-ci.com/kkbrum/PSMOptimalCalipers)
<!-- badges: end -->
